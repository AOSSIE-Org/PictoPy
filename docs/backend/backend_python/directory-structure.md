...
| `folders.py`          | Add, sync, update AI tagging, delete, and list folders, managing folder hierarchy and image processing asynchronously. Runs the SigLIP2 embedding pass after YOLO and face processing, and before semantic scoring, memory curation and the video pass (see [Semantic Search](semantic-search.md)). |
