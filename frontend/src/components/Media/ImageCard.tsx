...
import { shareImage } from '@/api/api-functions/share_image';
  ...
  return (
    <>
          ...
          <AspectRatio ratio={1}>
            ...
            <div className="absolute inset-0 flex items-center justify-center gap-2 opacity-0 transition-opacity duration-200 group-hover:opacity-100">
              ...
              <Button
                variant="ghost"
                size="icon"
                className="cursor-pointer rounded-full bg-white/20 text-white transition-all duration-300 hover:bg-white/40 hover:shadow-lg"
                onClick={handleShare}
                title="Share"
                aria-label="Share"
              >
      ...
      <ShareModal
        ...
        imagePath={image.path || image.thumbnailPath || ''}
