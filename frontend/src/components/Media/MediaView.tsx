    ...
    <div className="fixed inset-0 z-50 flex flex-col bg-black">
      <div className="absolute right-4 top-4 z-50 flex items-center gap-2">
        {!isSecureFolder && (
          <button
            onClick={handleShare}
            className="rounded-full bg-gray-500 p-2 text-white transition-colors duration-200 hover:bg-gray-700"
            aria-label="Share"
          >
        ...
        {type === 'image' && (
          <button
            ...
            className="rounded-full flex items-center gap-2 bg-gray-500 px-4 py-2 text-white transition-colors duration-200 hover:bg-gray-700"
      ...
      >
        ...
        <button
          ...
          className="rounded-full absolute left-4 top-1/2 z-50 flex items-center bg-gray-500 p-3 text-white transition-colors duration-200 hover:bg-gray-700"
        >
          <ChevronLeft className="h-6 w-6" />
        </button>
        <button
          onClick={handleNextItem}
          className="rounded-full absolute right-4 top-1/2 z-50 flex items-center bg-gray-500 p-3 text-white transition-colors duration-200 hover:bg-gray-700"
        >
      ...
      {type == 'image' ? (
        <div className="absolute bottom-20 right-4 flex gap-2">
          <button
            ...
            className="rounded-md bg-gray-500 p-2 text-white transition-colors duration-200 hover:bg-gray-700"
            aria-label="Zoom Out"
          >
          ...
          <button
            onClick={resetZoom}
            className="rounded-md bg-gray-500 px-4 py-2 text-white transition-colors duration-200 hover:bg-gray-700"
          >
            Reset
          </button>
          <button
