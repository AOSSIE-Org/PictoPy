...
const WebcamCapture: React.FC<WebcamCaptureProps> = ({ onCapture, onClose }) => {
    ...
    const cleanupResources = async () => {
        console.log(`Cleaning up WebSocket resources for instance ${instanceId.current}`);
    ...
    const connectWebSocket = async () => {
        ...
        console.log(`Starting connection attempt #${attemptRef.current} with ID: ${connectionClientId}`);
        ...
        if (socketRef.current) {
            console.log("Waiting for previous socket to close before creating a new one");
            await cleanupResources();
        ...
        <div className="flex flex-col gap-4 w-full max-w-full">
                    ...
                    {isConnecting ? (
                        ...
                        <div className="relative w-full">
                            <img
                                ...
                                alt="Webcam feed"
                            />
                            <div className="absolute left-2 top-2 rounded-full bg-black/60 px-3 py-1 text-sm text-white">
                                {facesDetected > 0 ?
            ...
            <div className="flex justify-between gap-2">
                <Button
                    ...
                    disabled={isConnecting || !!error || isCapturing || facesDetected === 0}
