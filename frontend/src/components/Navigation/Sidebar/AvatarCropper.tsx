  ...
  return (
    <div className="flex flex-col items-center gap-6 p-4">
      ...
      <div className="w-full max-w-xs space-y-2">
        ...
        <div className="bg-white/50 rounded-lg p-2 shadow-sm dark:bg-gray-700/50">
          <input
            type="range"
            min={1}
            max={3}
      ...
      <div className="flex gap-4">
        <button
          ...
          className="rounded-lg bg-gradient-to-r from-blue-500 to-purple-600 px-6 py-2.5 text-white shadow-lg transition-all duration-300 hover:shadow-xl hover:translate-y-[-1px] active:translate-y-[1px] focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
        >
          Apply Crop
        </button>
      </div>
      ...
      {croppedPreview && (
        <div className="mt-2 w-full max-w-xs">
          <h3 className="mb-2 text-center text-sm font-semibold text-gray-600 dark:text-gray-300">Preview</h3>
