        ...
        <div className="flex flex-col items-center text-center">
          <div className="flex items-center justify-center gap-4 mb-4">
            <img
              ...
              className="h-16 w-16 object-contain"
            />
            <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-yellow-500 to-green-500">
              PictoPy
            </h1>
          </div>

          <p className="text-xl md:text-2xl text-green-700 dark:text-yellow-300 max-w-3xl mb-8">
            Organize your photos effortlessly. Available for Mac, Windows, and Linux.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="https://github.com/AOSSIE-Org/PictoPy/releases/latest/download/PictoPy-mac.dmg"
              target="_blank"
              rel="noopener noreferrer"
              onClick={() => handleDownloadClick("Mac")}
            >
              <Button className="bg-black text-white h-12 px-8">
                <img src={MacLogo} className="h-7 w-7 mr-2" />
                Download for Mac
              </Button>
            </a>

            <a
              href="https://github.com/AOSSIE-Org/PictoPy/releases/latest/download/PictoPy-windows.exe"
              target="_blank"
              rel="noopener noreferrer"
              onClick={() => handleDownloadClick("Windows")}
            >
              <Button className="bg-black text-white h-12 px-8">
                <img src={WindowsLogo} className="h-7 w-7 mr-2" />
                Download for Windows
              </Button>
            </a>

            <a
              href="https://github.com/AOSSIE-Org/PictoPy/releases/latest/download/PictoPy-linux.deb"
              target="_blank"
              rel="noopener noreferrer"
              onClick={() => handleDownloadClick("Linux")}
            >
              <Button className="bg-black text-white h-12 px-8">
                <img src={LinuxLogo} className="h-9 w-9 mr-2" />
                Download for Linux (.deb)
              </Button>
            </a>
          </div>
          ...
          {downloadStarted && (
            <div className="fixed top-16 right-4 bg-green-500 text-white py-3 px-6 rounded-lg shadow-xl z-50">
              {downloadStarted}
            </div>
          )}
        </div>
