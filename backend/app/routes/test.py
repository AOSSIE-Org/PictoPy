...
# from app.database.folders import db_get_all_folder_ids
# import os
# import shutil
...
#         raise HTTPException(
#             status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
#             detail=ErrorResponse(success=False, message="Internal server error", error=str(e)).model_dump(),
#         )
...
# def test_images():
#     try:
#         folder_ids = db_get_all_folder_ids()
