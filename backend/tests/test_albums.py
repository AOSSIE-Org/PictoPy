...
def test_view_album_photos():
    with patch('app.database.albums.get_album_photos', return_value=["image1.jpg", "image2.jpg"]):
...
def test_get_albums():
    mock_albums = [{"name": "Album1", "description": "Desc1"}, {"name": "Album2", "description": "Desc2"}]
