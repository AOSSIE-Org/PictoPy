...
from app.database.smart_album import db_create_smart_albums_table
...
from app.routes.smart_album import router as smart_album_router
...
app.include_router(smart_album_router, prefix="/smart-albums", tags=["Smart Albums"])
