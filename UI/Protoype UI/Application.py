...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_2.setMaximumSize(QtCore.QSize(210, 584))
        self.label_2.setText("")
        self.label_2.setPixmap(QtGui.QPixmap(":/icon/icon/alex-perez-pEgsWN0kwbQ-unsplash.jpg"))
        self.label_2.setScaledContents(True)
        self.label_2.setObjectName("label_2")
        self.horizontalLayout_5.addWidget(self.label_2)
        self.label_4 = QtWidgets.QLabel(self.page)
        self.label_4.setMaximumSize(QtCore.QSize(210, 584))
        self.label_4.setText("")
        self.label_4.setPixmap(QtGui.QPixmap(":/icon/icon/jean-philippe-delberghe-75xPHEQBmvA-unsplash.jpg"))
        self.label_4.setScaledContents(True)
        self.label_4.setObjectName("label_4")
        self.horizontalLayout_5.addWidget(self.label_4)
        self.label_3 = QtWidgets.QLabel(self.page)
        self.label_3.setMaximumSize(QtCore.QSize(210, 584))
        self.label_3.setText("")
        self.label_3.setPixmap(QtGui.QPixmap(":/icon/icon/pawel-czerwinski-6lQDFGOB1iw-unsplash.jpg"))
        self.label_3.setScaledContents(True)
        self.label_3.setObjectName("label_3")
        self.horizontalLayout_5.addWidget(self.label_3)
        self.label = QtWidgets.QLabel(self.page)
        self.label.setMaximumSize(QtCore.QSize(210, 584))
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap(":/icon/icon/usgs-hoS3dzgpHzw-unsplash.jpg"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.logo_label_3.setText(_translate("MainWindow", "PictoPy"))
        self.home_btn_2.setText(_translate("MainWindow", "Home"))
        self.dashborad_btn_2.setText(_translate("MainWindow", "Settings"))
        self.orders_btn_2.setText(_translate("MainWindow", "View All "))
        self.products_btn_2.setText(_translate("MainWindow", "Sorted Gallery(?)"))
        self.customers_btn_2.setText(_translate("MainWindow", "People"))
        ...
        self.label_6.setText(_translate("MainWindow", "View All Images"))
        self.label_7.setText(_translate("MainWindow", "Sorted Gallery"))
        self.label_8.setText(_translate("MainWindow", "Sorted by People"))
